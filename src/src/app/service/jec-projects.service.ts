  ...
  public getData(): Observable<any> {
    const result: any = {
      projects: [
        ...
        { label: "jec-sokoke", description: "The Sokoke framework is the default implementation of the JavaScript Dependency Injection (JDI) specification.", progress: 100 },
        { label: "jec-glasscat-core", description: "The core components of the Glasscat Aplication Server.", progress: 100 },
        ...
        { label: "jec-jdi", description: "The JavaScript Dependency Injection (JDI) framework provides the ability to inject components into a JEC application in a typesafe way.", progress: 100 },
        { label: "jec-glasscat-install", description: "Contains install utilities for the GlassCat application server.", progress: 100 },
        { label: "jec-glasscat", description: "GlassCat Application Server is the default JEC implementation.", progress: 100 },
        { label: "jec-exchange-mock", description: "Mocking library for testing objects built over the JEC Exchange API, including @WebJslets and @Bootstrap decorators.", progress: 100 },
        ...
        { label: "jec-cli", description: "CLI tool for managing JEC projects. You typically use JEC CLI to install and start a GlassCat application server.", progress: 100 },
        ...
        { label: "jec-juta", description: "A simple API to write repeatable tests over common JavaScript unit testing frameworks.", progress: 100 },
        ...
        { label: "jec-cheetoh", description: "The GlassCat Project Model (GPM) manager.", progress: 100 },
